...
class RepositoryItemDetails extends Component {
  state = {
    ...
    isValidUser: true, // this line handles the case of invalid or empty username
  }
  ...
  getGitHubUserRepositoryItemDetails = async () => {
    ...
    const url = `https://apis2.ccbp.in/gpv/specific-repo/${username}/${repoName}?api_key={token}`
    const options = {
      method: 'GET',
    }
